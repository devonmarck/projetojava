...
public class Alunos {
	public static void main(String[] args) {
		       ...
		       //Objeto 1
				...
				aluno1.emailEducacional = "nathan.martins2004@gmail.com";
			    aluno1.mencao = "D";
				...
				aluno2.emailEducacional  = "victoriacardoso545@gmail.com";
			    aluno2.mencao = "N";
			    System.out.println("Nome: " + aluno2.nome);
				System.out.println("Telefone: " + aluno2.telefone);
				System.out.println("Email: " + aluno2.emailEducacional);
				aluno2.ligarPc();
				aluno2.desligarPc();
